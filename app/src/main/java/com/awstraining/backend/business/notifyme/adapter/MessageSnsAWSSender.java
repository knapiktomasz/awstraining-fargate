...
public class MessageSnsAWSSender implements MessageSender {
    ...
    public void send(String text) {
        ...
        //Log information about successful sent message to topic with topic arn and message id
        LOGGER.info("Message sent to topic: {} with message id: {}", snsTopicArn, publish.getMessageId());
